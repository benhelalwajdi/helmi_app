...
import 'package:helmi_app/food/utils/FoodImages.dart';
import 'package:helmi_app/food/utils/FoodString.dart';
import 'package:helmi_app/food/utils/FoodWidget.dart';
import 'package:helmi_app/food/utils/dots_indicator/src/dots_decorator.dart';
import 'package:helmi_app/food/utils/dots_indicator/src/dots_indicator.dart';
                  ...
                  Row(
                    ...
                    children: <Widget>[
                      GestureDetector(
                        ...
                        onTap: () {
                          finish(context);
                         // launchScreen(context, FoodSignIn);
                        },
                      ),
                      DotsIndicator(
                          dotsCount: 3,
